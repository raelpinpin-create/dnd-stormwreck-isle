...
# ⚡ Player 1: Eflein
* **Title:** **« Warden of the Living Grove »** *(Honored Myconid Sovereign Title)*
...
| :--- | :--- | :--- |
| **Hit Points (HP)** | **20 / 20** | Hit Dice: `3d6 + 6 CON` (Level 3 Upgraded) |
...
| **CON** | 14 | +2 | +2 | — |
| **INT** | 16 | +3 | **+5 (Proficient)** | **Arcana (+5)**, **History (+5)**, **Investigation (+5)**, Nature (+3), Religion (+3) |
...
| **Hit Points (HP)** | **27 / 27** | Hit Dice: `3d8 + 6` (CON +2) |
...
# 🍷 Player 3: Father Flubs
* **Titles:** **« The Serpent Rider »** & **« Warden of the Living Grove »** *(Honored Myconid Sovereign Titles)*

## 📜 Character Profile
* **Name:** Father Flubs
* **Race:** Human
* **Class & Level:** **Cleric 3 (Life Domain)** *(Level 3 Full Upgrade!)*
* **Background:** Acolyte
...
* **Role in Party:** Primary Divine Healer, Party Buffer, Anti-Undead Purifier, Wisdom Anchor & Moral Keystone.

## ⚔️ Combat Statistics
| Attribute | Value | Notes |
| :--- | :--- | :--- |
| **Hit Points (HP)** | **24 / 24** | Hit Dice: `3d8 + 6 CON` (Level 3 Upgraded) |
...
| **Help Tokens** | **2 / 2** | Help (+1d6 to ally within 30ft, 2/LR, +1 on SR) |
| **Passive Perception** | **15** | Base Wisdom (+3) + PB (+2) |
| **Proficiency Bonus** | **+2** | |
...
| **WIS** | 16 | +3 | **+5 (Proficient)** | Animal Handling (+3), **Insight (+5)**, **Medicine (+5)**, Perception (+3), Survival (+3) |
| **CHA** | 12 | +1 | **+3 (Proficient)** | Deception (+1), Intimidation (+1), Performance (+1), **Persuasion (+3)** |

## ✨ Divine Domain Features & Spellcasting (Level 3 Life Cleric)
* **Spell Save DC:** **13** (`8 + 2 PB + 3 WIS`)
* **Spell Attack Bonus:** **+5** (`+2 PB + 3 WIS`)
* **1st-Level Spell Slots:** `3 / 4` (Used 1 slot earlier; 3 slots remaining)
...
* **Domain Spells (Always Prepared):** 
  * *1st-Level:* *Bless* (Concentration, 3 allies gain +1d4 to attack rolls and saves), *Cure Wounds* (`1d8 + 3 WIS + 3 Disciple = 1d8 + 6 HP`).
  * *2nd-Level:* *Lesser Restoration* (Cures disease, blindness, deafness, paralysis, or poison), *Spiritual Weapon* (Bonus Action magical spectral hammer attack: `+5 to hit`, `1d8 + 3` force damage, moves 20 ft/round, no concentration!).
* **Prepared Spells (6 Spells Prepared):** *Healing Word* (Bonus Action, `1d4 + 3 + 3 = 1d4 + 6 HP`), *Guiding Bolt* (`+5 to hit`, `4d6` radiant + Adv on next attack), *Shield of Faith* (+2 AC bonus), *Detect Evil and Good*, *Prayer of Healing* (2nd-Level: 10 min cast, heals `2d8 + 3 + 4 = 2d8 + 7 HP` to up to 6 allies!), *Hold Person* (2nd-Level: DC 13 Wis save or Paralyzed).
...
## 🎒 Inventory & Wealth
* **Armor & Shields:** 
  * 🥋 Scale Mail Armor (Base AC 14)
  * 🛡️ Holy Wooden Shield (+2 AC)
  * 🛡️ **Kobold Shield** *(Gifted by the mysterious strangers)*
* **Weapons:** 
  * 🔨 Ceremonial Heavy Mace (`+3 hit`, `1d6+1` bludgeoning)
...
# 🛡️ Player 4: General Varnoth (Lead DM Controlled)
* **Titles:** **« Warden of the Living Grove »** & **« The Indomitable Iron-Oak »** *(Honored Myconid Sovereign Titles)*
...
| Attribute | Value | Notes |
| :--- | :--- | :--- |
| **Hit Points (HP)** | **29 / 29** | Hit Dice: `3d8 + 6 CON` (Level 3 Upgraded) |
...
* **Armor & Weapons:** 
  * 🥋 Splint Mail (AC 15)
  * 🛡️ Azure Wolf Steel Shield (+2 AC)
