...
* **Spellcasting Specs:** Base Spell Save DC **14** *(DC 15 for Lightning)* | Base Spell Attack Bonus **+6** *(+7 for Lightning via Awakened Scale)* | **1st-Level Slots:** **2 / 4** | **2nd-Level Slots:** **1 / 3** | 👘 **Robe of Arcane Reserve:** `1/1` | 🤝 **Help Tokens:** `2 / 2`
* **Evocation Features:** 🔮 **Evocation Savant** | 💥 **Sculpt Spells** (Protects allies from AoE damage!)
* **Key Items:** 📜 **Lianna's Farewell Letter (The Archmage's Vow)**, 🥽 **Myla's Draconic Abyssal Goggles** (Darkvision 60ft & Murky Underwater Clarity), 🪄 **Wand of Magic Missiles (4/7 Charges)**, Astalagan's Awakened Amber Scale (+1 Focus/DC), Cracked Lodestone Bracelet (+1 Init, magnetic Mage Hand), Robe of Arcane Reserve (+1 Slot), Shortsword & Cutlass, Sling of the Ridge-Runner (+1), Scroll of Absorb Elements, Spore-Filter Rebreather Mask, 🧪 **1x Potion of Water Breathing**, 🍷 **1x Elixir of Health (Legendary)**, 🧀 Cheese Bread, 28 gp 9 sp. *(Ate Special Bread)*.
...
* **Hit Points (HP):** **16 / 31** (Revived via Elixir of Life; suffers -2 to d20 rolls until Long Rest) | **Armor Class (AC):** **16** (Leather + DEX +4 + 🛡️ Cloak of Protection) | **Speed:** 30 ft *(Feline Agility: 60 ft)* | **Initiative:** **+4** | **Passive Perception:** 13
* **Bardic Spellcasting Specs:** Spell Save DC **14** | Spell Attack Bonus **+6** | **1st-Level Spell Slots:** **3 / 4** | **2nd-Level Spell Slots:** **3 / 3** | **Bardic Inspiration:** `2 / 4` (d6) | 🪡 **Suture Chord:** `0 / 2` | 🤝 **Help Tokens:** `2 / 2`
...
* **Key Gear & Weapons:** 🛡️ **Cloak of Protection** (+1 AC / +1 Saves), 🎻 **Lyra (+1 Cello Bowstring Rapier / Instrument)** (`+7 hit`, `1d8+5` + `1d6 Thunder`, Suture Chord 0/2: DC 14 Dex save, `2d8 Thunder + Speed 0`), 🗡️ **Rapier (+6 hit, 1d8+4 + 2d6 Psychic Blades)**, 🗡️ **Sentry Zik's Dagger (+1)** (+7 hit, 1d4+5), 🗡️ Steel Dagger 2x (+6 hit, 1d4+4), 🪶 **Sentry Zik's Remains & Silk Ribbon**, 🍷 **1x Elixir of Health (Legendary)**, 🪘 Tambourine (Focus), 🎸 Lute & Guitar, 👗 Neko Maid Costume, 💣 1x Spitfire Flask (2d4 Fire), Thieves' Tools, Burglar's & Entertainer's Packs, 15 gp 0 sp. *(Kobold Sweetbread Roll consumed)*.
...
* **Hit Points (HP):** **31 / 31** (Hit Dice: `4d8 + 8 CON` — Level 4 Upgraded) | **Armor Class (AC):** **18** (Scale Mail + Shield) | **Speed:** 30 ft | **Passive Perception:** 16
* **Divine Magic Specs:** Spell Save DC **14** | Spell Attack Bonus **+6** | **1st-Level Spell Slots:** **2 / 4** | **2nd-Level Spell Slots:** **0 / 3** | 🤝 **Help Tokens:** `2 / 2`
* **Channel Divinity (1/Short Rest):** 🕊️ **Preserve Life** (Heals up to **20 HP** distributed to bloodied allies within 30 ft — 0/1 Used).
...
* **Key Gear, Relics & Potions:** 🍾 **The Vintage of the Dawn Watch** (Sacred Jug & Holy Symbol), 📿 **The Enlightened Bone Charm** *(Advantage vs Charmed/Frightened & Turn Undead)*, 🐉 **Jar of Pure Drake Blood**, 🏺 **1x Jar of Animal Remains**, 🏴‍☠️ **1x Pirate Hat**, 🧪 **6x Potions of Healing (Bonus: 2d6 / Action: Full Heal)**, 🍷 **0x Elixir of Life** *(Used on Sylvar in Session 7)*, 🧪 **2x Diluted Drake Blood Potions (+1 ATK, +2 DMG all day)**, Heavy Mace, Wooden Shield, Kobold Shield, Scale Mail, 52 gp 5 sp. *(Consumed 1x Elixir of Health & 1x 3-Circle Amulet)*.
...
* **Hit Points (HP):** **23 / 36** (Hit Dice: `4d8 + 8 CON` — Level 4 Upgraded) | **Armor Class (AC):** **17** (Splint Mail 15 + Shield +2) | **Speed:** 30 ft | **Passive Perception:** 14 | 🤝 **Help Tokens:** `1 / 2`
* **Martial Role Features:** 💥 **Improved Critical (Crits on 19 or 20!)**, ⚡ **Battle Readiness (Advantage on Initiative rolls)**.
* **Defensive Features & Actions:** 🛡️ *Protection Reaction* (Disadvantage on attacks vs adjacent ally), 💨 *Second Wind* (1d10+4 HP — Ready), ⚡ *Action Surge* (1 Extra Action per Short Rest — 0/1 Used), 🪓 *Shield Bash* (Athletics +6 vs Prone).
* **Equipment:** Splint Mail, Azure Wolf Steel Shield, Honed Longsword (+6 hit, 1d8+4/1d10+4, Crits on 19-20), Heavy Crossbow (+2 hit, 1d10), 🪓 Twin Notched Bone-Cleavers (Kobold Champion Trophy), 🍷 **1x Elixir of Health (Legendary)**, 🧪 0x Potions of Healing *(Consumed 1 in Session 7)*, 8 gp 6 sp.
...
* **Chapter Objectives & Awakening Trail:**
  1. ⚓ **The Neverwinter Lead & Tavern Extravaganza (Prologue):** Uncovered the 8-month-old vanguard charter with Barnaby; arrived at Dragon's Rest, threw a legendary Nat 20 Neko Maid tavern performance (giving Varnoth her famous hangover!), charmed Sentry Zik, ran Tarak's deliveries, and earned Runara's blessing.
  2. 🚢 **The Shipwreck Vanguard Trail & Zephyr Awakening (Ch 3 - Compass Rose):** Senses twin-crescent blade score-marks on the main deck where Lyra held the line against undead; dives into submerged hold C9 to recover and attune to 🌪️ **Scale of the Zephyr (Clyssavar's Silver Scale)** (*+1 Spell Attack/DC, Deafened Immunity, Thunder Resistance, 1/Day Gale-Burst 10ft Push, Whispers on the Wind*).
  3. 🔭 **Observatory Seismic Alignment (Ch 4 - D5):** Uses acoustic whiskers and floor vibration sensitivity to solve the 4 Scholar Statues balance alignment in harmony with Eflein's star math, unlocking the secret vault.
  4. 🌪️ **The Zephyr Roar & Tri-Draconic Convergence (Ch 4 - D6):** Channels Clyssavar's Silver Scale into the Tri-Draconic Convergence, unleashing gale shockwaves to knock Sparkrender from the air and seal Sharruth's volcanic tomb.
  5. 📜 **The Twin Sister's Vanguard Coordinates:** Discovers the stone world-atlas coordinates left by Lianna and Lyra, confirming his twin sister is alive, thriving, and awaiting him across the sea!
* **Rewards & Milestones:** 🌪️ **Clyssavar's Silver Scale**, *« Vanguard of the Wind-Drift »* Title, and Level 5 Master Tier.
...
| **⛩️ Dragon's Rest** | 🐉 **Elder Runara** | `⭐ MET & ACTIVE` | 19 | 212 | **+0** | Fly 80 | **🧭 Restorative Pacifism & Sanctuary Mother:** Cycles of blood-feuds must end.<br>⚡ *Refuses to fly to Observatory due to 4 sacred pillars: (1) Sharruth Leyline Rupture, (2) Sparkrender's Comet Siphon Trap, (3) Sanctuary Ward collapse leaving kobolds defenseless, and (4) The Moral Lesson of Aidron (breaking the might-makes-right cycle). Commissioned Myla to build the Galvanic Ley-Grounder.* | Serene, gentle, maternal ancient wisdom holding immense power in restraint. *"Every weapon forged is a promise to bleed. Here, we seek what remains."* |
...
| | 🗡️❤️ **Zik** | `💖 MET & CHARMED` | 13 | 10 | **+2** | 30 ft | **🧭 Aggressive Defense Melted by Love:** Peace requires vigilance, but love softens all.<br>⚡ *Daydreaming about Sylvar's slow dance; blushing through his scales on duty.* | Proud, raspy sentry barking softened by shy romantic squeaks. *"H-halt! Look, tell Sylvar I kept his ribbon!"* |
...
| 🍷 **Elixir of Life (Legendary)** | **HEAL • Legendary Potion** | Tarak / Ruby Morel (3 in Flubs' Pouch) | `5,000 GP` *(Base)* / `15,000 GP` *(Royal Market)* | **Action:** Administer to a creature that has died within the last minute. The creature returns to life with **`50% Max HP`**, and any severed limbs are knit back together. Suffers a **`-2 penalty`** to all attack rolls, saving throws, and ability checks until finishing a Long Rest. |
...
| 🍷 **The Ruby Morel (Raw)** | **REAGENT • Rare Fungal Relic** | Area B5 Fungal Throne (Seagrow Caves) | `1,500 GP` *(Priceless Relic)* | Sacred fungal relic. Tarak distills 1 morel into 1x Legendary Elixir of Life. |
